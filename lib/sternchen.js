...
(function() {
  var PhantomError, ReportWriter, Sternchen, basename, dirname, exit, extname, fs, join, path, running, _onPhantomError,
  ...
  Sternchen = (function(_super) {
    ...
    Sternchen.prototype.addTest = function(test) {
      var _ref;
      this.stats.tests++;
      if (((_ref = this.currentSuite) != null ? _ref.tests : void 0) != null) {
