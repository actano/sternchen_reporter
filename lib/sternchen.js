...
(function() {
  ...
  ReportWriter = (function() {
    ...
    ReportWriter.prototype.createReportFile = function() {
      ...
      this.reportFile = process.env.REPORT_FILE;
      if ((this.reportFile != null) && this.reportFile.length > 0) {
        this["package"] = path.join(path.dirname(this.reportFile), path.basename(this.reportFile, path.extname(this.reportFile))).replace(/\//g, '.');
        prefix = process.env.PREFIX;
        if (prefix != null) {
          this.reportFile = path.join(prefix, this.reportFile);
        }
