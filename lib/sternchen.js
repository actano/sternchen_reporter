...
(function() {
  var MAKE_TARGET, PREFIX, REPORT_FILE, ReportWriter, Sternchen, debug, exit, fs, mkdirp, path, ref,
  ...
  ref = process.env, REPORT_FILE = ref.REPORT_FILE, PREFIX = ref.PREFIX, MAKE_TARGET = ref.MAKE_TARGET;
  ...
  ReportWriter = (function() {
    ...
    ReportWriter.prototype.createReportFile = function() {
      ...
      if ((this.reportFile != null) && this.reportFile.length > 0) {
        ...
        directory = path.dirname(this.reportFile);
        mkdirp.sync(directory);
        this.tempFile = this.reportFile + '.tmp';
        debug("creating temp report file " + this.tempFile);
    ...
    ReportWriter.prototype.closeReportFile = function() {
      if (this.fd != null) {
        ...
        debug("moving temp file to " + this.reportFile);
  ...
  Sternchen = (function(superClass) {
    ...
    Sternchen.prototype.addTest = function(test) {
      debug("adding test '" + (test != null ? test.title : void 0) + "'");
      this.stats.tests++;
    ...
    Sternchen.prototype.initalizeEvents = function() {
      ...
      this.runner.on('pending', (function(_this) {
        return function(test) {
          debug("pending test '" + (test != null ? test.title : void 0) + "'");
          _this.addTest(test);
          _this.stats.pending++;
          test.skipped = true;
      ...
      this.runner.on('pass', (function(_this) {
        return function(test) {
          debug("test '" + (test != null ? test.title : void 0) + "' passed");
          _this.addTest(test);
          _this.stats.passes++;
      ...
      this.runner.on('fail', (function(_this) {
        return function(test, err) {
          ...
          debug("test '" + (test != null ? test.title : void 0) + "' failed");
