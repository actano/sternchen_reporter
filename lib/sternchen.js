    ...
    Sternchen.prototype.initalizeEvents = function() {
      ...
      this.runner.on('fail', (function(_this) {
        return function(test, err) {
          var failureHandler, i, len, ref, ref1;
          if ((ref = test.onFailureHandlers) != null ? ref.length : void 0) {
            if (test.stdout == null) {
              test.stdout = '';
            }
            ref1 = test.onFailureHandlers;
            for (i = 0, len = ref1.length; i < len; i++) {
              failureHandler = ref1[i];
              test.stdout += failureHandler(path.dirname(_this.reportFile));
            }
          }
          _this.addTest(test);
          test.err = err;
